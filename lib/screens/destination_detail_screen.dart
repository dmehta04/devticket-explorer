...
import 'places_explorer_screen.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          // Set this destination selected on map
          ref.read(selectedDestinationIdsProvider.notifier).state = {destination.id};
          ref.read(mapFocusDestinationProvider.notifier).state = destination;
          ref.read(currentTabProvider.notifier).state = 1; // Map tab
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Rich Attractions (from API)
                  _AttractionsSection(destinationId: destination.id),
                      ...
                      TextButton.icon(
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (_) =>
                                PlacesExplorerScreen(destination: destination),
                          ));
                        },
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Discover places to eat & drink near ${destination.city}',
                                style: TextStyle(
                                  fontSize: 12,
...
class _AttractionsSection extends ConsumerWidget {
  ...
  const _AttractionsSection({required this.destinationId});
      ...
      data: (attractions) {
        ...
        return Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            ...attractions.map((a) => AttractionCard(attraction: a)),
          ],
        );
      },
